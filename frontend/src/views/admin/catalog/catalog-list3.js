...
import {catalog3DataFetch,selectedCatalog3StatusUpdate,selectedCatalog3Delete,getDecodeJwt} from "../../../service/web/userService";
...
const UserList =() =>{
    ...
    const  deleteRecord= async () =>{
        ...
        try{
            const response =await selectedCatalog3Delete(selectRow.id)
            if(response){
    ...
    const  handleToggle=async (item,idx)=>{
        ...
        //update db api
        try{
            const response = await selectedCatalog3StatusUpdate(item.id)
            if(response){
                let newArr = [...catalog1List];
                        ...
                        <Card>
                            <Card.Header className="d-flex justify-content-between">
                                <div className="header-title">
                                    <h4 className="card-title">Catalog 3</h4>
                                </div>
                            </Card.Header>
